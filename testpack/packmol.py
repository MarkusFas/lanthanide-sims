...
DEFAULT_STRUCTURES = Path("~/project-solvation/cesare/i-solvate/initial_structures")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--box-length", type=float, default=20.0, help="Length of the cubic box in Angstroms (default: 20.0)")
    ...
    solvated = solvate_molecule(
        ...
        solvents_csv=args.structures_dir + "/solvents.csv",
